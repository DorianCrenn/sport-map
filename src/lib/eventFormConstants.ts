export const BREST = { name: 'Brest', lat: 48.3904, lng: -4.4861 } as const;
...
export const CHAMPIONSHIP_LEVELS: Record<string, SelectOption[]> = {
  Football: [
...
export const CUP_TYPES: SelectOption[] = [
...
export const NUM_TEAMS_OPTIONS: string[] = ['4', '6', '8', '10', '12', '16', '24', '32'];

export const TOURNAMENT_FORMATS: SelectOption[] = [

...
export default function EventPredictions({ eventId, event }: EventPredictionsProps) {
  ...
  return (
    <div style={{ borderRadius: 14, border: '1px solid var(--sl-border)', backgroundColor: 'var(--sl-card)', padding: '10px 12px 12px', marginBottom: 12 }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
        ...
        {isLocked ? (
          <span style={{ fontSize: 10, fontWeight: 700, padding: '2px 8px', borderRadius: 20, color: 'var(--sl-t3)', backgroundColor: 'var(--sl-surface)', border: '1px solid var(--sl-border-s)' }}>⏱ Verrouillé</span>
        ) : !isLoggedIn ? (

...
export default function CSVImportModal({ onBulkSave, onClose }) {
  ...
  return (
    <motion.div
      ...
      style={{ position: 'fixed', inset: 0, zIndex: Z.formModal, backgroundColor: 'rgba(0,0,0,0.65)', backdropFilter: 'blur(6px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}
    >
      <motion.div
        key="csv-sheet"
        initial={{ y: '100%' }}

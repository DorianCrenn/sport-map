...
/**
 * HelpTooltip — Icône "?" inline qui affiche une bulle d'aide au clic.
 *
 * Usage :
 *   <HelpTooltip content="Explication du champ terrain : stade, gymnase, etc." />
 */
export default function HelpTooltip({ content, size = 14 }) {

...
export function GalleryBlockEditor({ block, onChange }) {
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: 'var(--sl-green)', color: '#fff', fontSize: 12, fontWeight: 700,
...
export function GalleryBlockView({ block }) {
  const images = block.data?.images ?? [];

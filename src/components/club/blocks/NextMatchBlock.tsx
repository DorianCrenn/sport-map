...
export default function NextMatchBlock({ data, allEvents, club }: NextMatchBlockProps) {
  ...
  return (
    <div style={{ borderRadius: 20, overflow: 'hidden', background: 'linear-gradient(135deg, var(--sl-surface) 0%, var(--sl-card) 100%)', border: '1px solid var(--sl-border-s)', boxShadow: '0 4px 24px rgba(0,0,0,0.18)' }}>

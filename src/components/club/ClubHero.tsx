        ...
        <>
          ...
          >
            ...
            <div style={{ padding: '4px 12px 0' }}>
              ...
              <button onClick={onClose} style={{ width: '100%', marginTop: 4, padding: '13px 14px', borderRadius: 13, border: 'none', backgroundColor: 'var(--sl-surface)', cursor: 'pointer', fontSize: 14, fontWeight: 700, color: 'var(--sl-t2)' }}>
                Annuler
              </button>
            </div>
          </motion.div>
    ...
    <div role="banner">
          ...
          <>
            ...
            <motion.div initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }} transition={{ type: 'spring', stiffness: 340, damping: 34 }} style={{ position: 'fixed', bottom: 0, left: 0, right: 0, zIndex: 301, backgroundColor: 'var(--sl-card)', borderRadius: '18px 18px 0 0', border: '1px solid var(--sl-border)', borderBottom: 'none', padding: '0 0 calc(16px + env(safe-area-inset-bottom, 0px))', boxShadow: '0 -8px 40px rgba(0,0,0,0.25)' }}>
              ...
              <div style={{ padding: '8px 12px 0', display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                <button onClick={() => setMapsOpen(false)} style={{ marginTop: 4, padding: '13px 14px', borderRadius: 13, border: 'none', backgroundColor: 'var(--sl-surface)', cursor: 'pointer', fontSize: 14, fontWeight: 700, color: 'var(--sl-t2)' }}>
                  Annuler
                </button>
              </div>
            </motion.div>
      ...
      <div style={{ position: 'relative', minHeight: 130, ...heroBackground, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px 0', position: 'relative', zIndex: 2 }}>
          <button onClick={onBack} aria-label="Retour à la liste des clubs" style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '8px 10px', borderRadius: 10, border: 'none', background: 'rgba(0,0,0,0.25)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.85)', fontSize: 12, fontWeight: 600, cursor: 'pointer', minHeight: 36 }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><polyline points="15 18 9 12 15 6"/></svg>
            Clubs
          </button>
          <div style={{ display: 'flex', gap: 6, position: 'relative' }}>
            <button onClick={onShare} aria-label="Partager" style={{ width: 36, height: 36, borderRadius: 10, border: 'none', background: 'rgba(0,0,0,0.25)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.8)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <button onClick={onMenuOpen} aria-label="Plus d'actions" style={{ width: 36, height: 36, borderRadius: 10, border: 'none', background: 'rgba(0,0,0,0.25)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.8)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="16" height="4" viewBox="0 0 20 4" fill="currentColor"><circle cx="2" cy="2" r="2"/><circle cx="10" cy="2" r="2"/><circle cx="18" cy="2" r="2"/></svg>
            </button>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: 'var(--sl-card)', borderBottom: '1px solid var(--sl-border)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'stretch', margin: '12px 14px', borderRadius: 14, border: '1px solid var(--sl-border)', backgroundColor: 'var(--sl-surface)', overflow: 'hidden' }}>

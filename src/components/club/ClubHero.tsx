    ...
    <div role="banner">
      ...
      <div style={{ position: 'relative', minHeight: 130, ...heroBackground, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 14px 0', position: 'relative', zIndex: 2 }}>
          <button onClick={onBack} aria-label="Retour à la liste des clubs" style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '10px 14px', borderRadius: 12, border: 'none', background: 'rgba(0,0,0,0.32)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.9)', fontSize: 15, fontWeight: 700, cursor: 'pointer', minHeight: 44 }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"><polyline points="15 18 9 12 15 6"/></svg>
            ← Retour
          </button>
          <div style={{ display: 'flex', gap: 8, position: 'relative' }}>
            <button onClick={onShare} aria-label="Partager" style={{ width: 44, height: 44, borderRadius: 12, border: 'none', background: 'rgba(0,0,0,0.32)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.9)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <button onClick={onMenuOpen} aria-label="Plus d'actions" style={{ width: 44, height: 44, borderRadius: 12, border: 'none', background: 'rgba(0,0,0,0.32)', backdropFilter: 'blur(8px)', color: 'rgba(255,255,255,0.9)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

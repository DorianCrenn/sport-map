/**
 * ClubTeamSection — Vue par équipe dans ClubPageView.
 * Contient : TrainingCalendarGenerator, TeamTrainingSection, TeamView.
 * Extrait de ClubPageView.jsx pour réduire sa taille.
 */
...
function TeamTrainingSection({ sessions, isEditing, onChange }) {
  ...
  function remove(id) { onChange(sessions.filter(s => s.id !== id)); }
...
export default function TeamView({ team, blocks, isEditing, updateBlock, addBlock, club, allEvents, trainings, onUpdateTrainings, onAddEventForTeam, canAddEvent, onBulkAddTrainingEvents }) {

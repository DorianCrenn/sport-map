...
export const SPORT_ICONS = {
  ...
  Running: `<circle cx="15" cy="4" r="2.5" fill="currentColor"/><path d="M14 6.5l-2 5.5M12 12l2.5 5M12 12l-3 5.5M13 9l3-2.5M13 9l-2.5 1.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M3 9h5M3 12h4M3 15h5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" fill="none"/>`,

  Trail: `<path d="M2 20h20" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M4 20L9 7l5 8 3-5 5 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M6 20l1.5-3.5 1.5 3.5" fill="currentColor"/>`,

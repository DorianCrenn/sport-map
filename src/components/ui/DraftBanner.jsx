...
/**
 * DraftBanner — Bandeau "Brouillon retrouvé" affiché en haut d'une modale.
 *
 * Usage :
 *   {hasDraft && (
 *     <DraftBanner
 *       onRestore={() => { const d = loadDraft(); setMessage(d.message); setType(d.type); clearDraft(); }}
 *       onDiscard={clearDraft}
 *     />
 *   )}
 */
export default function DraftBanner({ onRestore, onDiscard }) {
  return (
    <motion.div
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: 'transparent', color: 'rgba(129,140,248,0.8)',

...
interface PosterRendererProps {
  ...
  overlayElements?: any[];
  aiOverlayElements?: any[];
  playerLayers?: any[];
  sponsorLogos?: any[];
  bgImageGradient?: boolean;
  [key: string]: any;
  showWatermark?: boolean;
}

const PosterRenderer = memo(function PosterRenderer({ templateId, data, format = 'story', previewWidth = 158, innerRef, outerRef, transforms = {}, bgPresetId = '', effects = {}, overlayElements = [], aiOverlayElements = [], playerLayers = [], sponsorLogos = [], showWatermark = true }: PosterRendererProps) {

      ...
      <div style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <div data-block="meta" style={{ marginBottom: 12, ...tr('meta') }}>
          {[
            ...
            { svg: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>, value: (event?.venue || event?.city || '—').slice(0, 30) },
          ].map(({ svg, value }, i) => (

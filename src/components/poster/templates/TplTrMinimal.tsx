import { getSportMeta, InfoRow, Grain, fmtDate, blockStyle, venueFs, scaledTitle } from './tourUtils.jsx';

const H = { story: 640, post: 450 };

// Clay Court — Roland Garros. Court lines as hero. Editorial split. Luxe tennis.
export default function TplTrMinimal({ event = {} as any, homeTeam, championship, tagline, accentColor, bgImage, format = 'story', transforms = {} as any }) {

...
export default function TrainingCard({ training, onOpenTrainings }) {
      ...
      <div className="px-4 py-3 flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span
              className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-violet-500/15 text-violet-400"
            >
              Ce soir
            </span>
          </div>
          ...
          <p className="text-[15px] font-bold text-[var(--sl-t1)] leading-snug">
            ...
            {location ? (
              <span className="font-normal text-[var(--sl-t2)]"> · {location}</span>
            ) : null}
          </p>
        </div>
        ...
        <button
          ...
          className="shrink-0 flex items-center gap-1.5 px-3.5 py-2 rounded-xl
                     bg-violet-600 text-white text-[12px] font-bold

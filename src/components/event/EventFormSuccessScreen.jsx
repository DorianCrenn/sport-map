...
export default function EventFormSuccessScreen({ createdEvent, onOpenPoster, onClose, isCoach = false }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* CTA convocations (coach + match uniquement) */}
      ...
      {/* Panel convocations (par-dessus le success screen) */}
      <AnimatePresence>
        {showConvocation && (
          <motion.div

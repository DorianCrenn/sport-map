...
export function useFilteredEvents(events, { sportGroup, dateRange, departmentId }) {
  return useMemo(() => {
    let result = events;
    ...
    if (sportGroup) {
      result = result.filter(e => e.sportGroup === sportGroup);
    }
  ...
  }, [events, sportGroup, dateRange, departmentId]);
}

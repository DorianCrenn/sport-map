    ...
    <div>
      ...
      <Section title="Finalités et base légale">
        ...
        <ul style={{ marginTop: 8, paddingLeft: 18, listStyleType: 'disc' }}>
          ...
          <li>Améliorer le service — <em>intérêt légitime</em></li>
        </ul>
      </Section>
      ...
      <Section title="Vos droits">
        ...
        <ul style={{ marginTop: 8, paddingLeft: 18, listStyleType: 'disc' }}>
          ...
          <li><strong style={{ color: 'var(--sl-t1)' }}>Portabilité :</strong> exporter vos données (fonctionnalité à venir)</li>
  ...
  return (
    <div>
      ...
      <Section title="Accès au service">
        ...
        <p style={{ marginTop: 6 }}>L'inscription est ouverte à toute personne physique âgée de 14 ans ou plus. Pour les mineurs de moins de 16 ans, le consentement parental est requis.</p>
      </Section>

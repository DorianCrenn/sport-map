...
export default function AuthPage({ onClose, onNeedOnboarding, onShowLegal, initialMode = 'login' }: AuthPageProps) {
  ...
  function set(k: string) {
    return (e: React.ChangeEvent<HTMLInputElement>) => { setForm(p => ({ ...p, [k]: e.target.value })); setError(''); };
  }
  ...
  function handleOAuthDone({ needsConfirmation, isNewUser }: { needsConfirmation: boolean; isNewUser: boolean }) {

...
export const demoClubRow = {
  ...
  categories: [
    { id: 'cat_seniors',   name: 'Seniors',   teams: [{ id: 'Équipe 1', name: 'Équipe 1', level: 'R2' }, { id: 'Réserve', name: 'Réserve', level: 'D1' }] },
    ...
    { id: 'cat_feminines', name: 'Féminines', teams: [{ id: 'Équipe F', name: 'Équipe F', level: 'R1 F' }, { id: 'U15 F', name: 'U15 F', level: 'D1 U15 F' }] },
  ],
  status:            'verified',

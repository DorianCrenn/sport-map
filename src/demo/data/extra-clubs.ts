...
export const clubRugby = {
  ...
  categories: [
    { name: 'Seniors', teams: [{ name: 'XV', level: 'Fédérale 3' }, { name: 'B XV', level: 'Régional' }] },
    { name: 'Jeunes', teams: [{ name: 'U18', level: 'Régional' }, { name: 'U16', level: 'Départemental' }] },
  ],
  status: 'active',
...
export const clubBasket = {
  ...
  categories: [
    { name: 'Seniors', teams: [{ name: 'Équipe A', level: 'Pré-Nationale' }, { name: 'Équipe B', level: 'Régionale 1' }] },
    { name: 'Jeunes', teams: [{ name: 'U17', level: 'Régional' }, { name: 'U15', level: 'Régional' }] },
    { name: 'Féminines', teams: [{ name: 'Seniors F', level: 'Régionale 2 F' }] },
  ],
  status: 'active',
...
export const clubHandball = {
  ...
  categories: [
    { name: 'Seniors', teams: [{ name: 'Équipe 1', level: 'N3' }, { name: 'Équipe 2', level: 'Régionale 1' }] },
    { name: 'Jeunes', teams: [{ name: '-18 ans', level: 'Régional' }, { name: '-16 ans', level: 'Régional' }] },
    { name: 'Féminines', teams: [{ name: 'Seniors F', level: 'Régionale 1 F' }] },
  ],
  status: 'active',
...
export const clubVolley = {
  ...
  categories: [
    { name: 'Seniors', teams: [{ name: 'Équipe M', level: 'Régionale 2' }, { name: 'Équipe F', level: 'Régionale 1 F' }] },
    { name: 'Jeunes', teams: [{ name: 'U18 M', level: 'Régional' }, { name: 'U18 F', level: 'Régional' }] },
  ],
  status: 'active',
